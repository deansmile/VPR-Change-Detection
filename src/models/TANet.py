...
class Temporal_Attention(nn.Module):
    ...
    Modified from DR-TANet, commit: 37cc3929833d61451b2fa4a92ccd4286cfc4fd34
    https://github.com/Herrccc/DR-TANet/blob/main/attention.py
    """
...
class TwoTemporalAttention(nn.Module):
    ...
    def __init__(
        ...
        super(TwoTemporalAttention, self).__init__()
        ...
        self.ta_att_1 = Temporal_Attention(**opts)
        self.ta_att_2 = Temporal_Attention(**opts)

    def forward(self, fm_t0, fm_t1):

        out_t0 = self.ta_att_1(fm_t0, fm_t1)
        out_t1 = self.ta_att_2(fm_t1, fm_t0)
